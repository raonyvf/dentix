<div class="flex flex-col h-full" x-data="{ adminOpen: false }">
    ...
    <?php $isSuperAdmin = Auth::user() && Auth::user()->isSuperAdmin(); ?>
    <nav class="flex-1 overflow-y-auto py-4">
        <?php if($isSuperAdmin): ?>
        <a href="<?php echo e(route('backend.index')); ?>" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100" :title="sidebarCollapsed ? 'Backend' : ''">
        ...
        <a href="<?php echo e(route('usuarios-admin.index')); ?>" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100" :title="sidebarCollapsed ? 'Usuários Admin' : ''">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <?php else: ?>
        <a href="<?php echo e(route('admin.index')); ?>" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100" :title="sidebarCollapsed ? 'Dashboard' : ''">
        ...
        <a href="<?php echo e(route('pacientes.index')); ?>" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100" :title="sidebarCollapsed ? 'Pacientes' : ''">
        ...
        <a href="<?php echo e(route('agenda.index')); ?>" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100" :title="sidebarCollapsed ? 'Agenda' : ''">
        ...
        <a href="<?php echo e(route('profissionais.index')); ?>" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100" :title="sidebarCollapsed ? 'Profissionais' : ''">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="<?php echo e(route('escalas.index')); ?>" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100" :title="sidebarCollapsed ? 'Escalas de Trabalho' : ''">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            <span class="ml-3" x-show="!sidebarCollapsed">Escalas de Trabalho</span>
        </a>
        <a href="<?php echo e(route('estoque.index')); ?>" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100" :title="sidebarCollapsed ? 'Estoque' : ''">
        ...
        <a href="<?php echo e(route('financeiro.index')); ?>" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100" :title="sidebarCollapsed ? 'Financeiro' : ''">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mt-2" x-data="{ open: false }">
            ...
            <div x-show="open && !sidebarCollapsed" x-collapse class="mt-1 space-y-1 pl-12" x-cloak>
                <a href="<?php echo e(route('clinicas.index')); ?>" class="block py-1 hover:underline">Clínicas</a>
                <a href="<?php echo e(route('cadeiras.index')); ?>" class="block py-1 hover:underline">Cadeiras</a>
                <a href="<?php echo e(route('formularios.index')); ?>" class="block py-1 hover:underline">Formulários</a>
            </div>
        </div>
        <div class="mt-2" x-data="{ openAccess: false }">
            ...
            <div x-show="openAccess && !sidebarCollapsed" x-collapse class="mt-1 space-y-1 pl-12" x-cloak>
                <a href="<?php echo e(route('usuarios.index')); ?>" class="block py-1 hover:underline">Usuários</a>
                <a href="<?php echo e(route('perfis.index')); ?>" class="block py-1 hover:underline">Perfis</a>
            </div>
        </div>
        <?php endif; ?>
    </nav>
</div>
<?php /**PATH C:\laragon\www\dentix\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>