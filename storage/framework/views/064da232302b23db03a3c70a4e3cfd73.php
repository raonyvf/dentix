...
<div class="mb-6 flex items-start justify-between">
    ...
    <div class="flex items-center gap-2">
        ...
        <a href="<?php echo e(route('agendamentos.index')); ?>" class="py-2 px-4 bg-blue-600 text-white rounded hover:bg-blue-700 flex items-center">
            + Nova Consulta
        </a>
    </div>
</div>
    ...
    <div class="space-y-4">
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center justify-between mb-2">
                <div class="flex items-center gap-2">
                    <a href="<?php echo e(route('agenda.index', ['year' => $prevDate->year, 'month' => $prevDate->month])); ?>" class="p-1" title="Mês anterior">&lt;</a>
                    <h2 class="font-semibold"><?php echo e($currentDate->translatedFormat('F Y')); ?></h2>
                    <a href="<?php echo e(route('agenda.index', ['year' => $nextDate->year, 'month' => $nextDate->month])); ?>" class="p-1" title="Próximo mês">&gt;</a>
                </div>
            ...
            <div class="grid grid-cols-7 gap-1 text-center text-sm">
                ...
                <?php for($day = 1; $day <= $daysInMonth; $day++): ?>
                    ...
                    ?>
                    <span class="p-1 rounded <?php echo e($isToday ? 'bg-blue-500 text-white' : ''); ?>"><?php echo e($day); ?></span>
                <?php endfor; ?>
            </div>
        </div>
    ...
    <div class="lg:col-span-1 space-y-4 lg:col-span-2">
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex justify-between items-start mb-4">
                <h2 class="text-lg font-bold">Consultas do Dia <span class="text-gray-500 font-normal"><?php echo e($today->format('d/m/Y')); ?></span></h2>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dentix\resources\views/agenda.blade.php ENDPATH**/ ?>