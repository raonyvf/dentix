    ...
    <div>
        ...
        <select name="clinic_id" class="border rounded px-2 py-1" onchange="this.form.submit()">
            <?php $__currentLoopData = $clinics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($c->id); ?>" <?php if($clinicId==$c->id): echo 'selected'; endif; ?>><?php echo e($c->nome); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
    <div>
        <label class="block text-sm font-medium mb-1">Ano</label>
        <input type="number" name="year" id="anoSelecionado" class="border rounded px-2 py-1" value="<?php echo e($month->year); ?>" onchange="this.form.submit()">
    </div>
    <div>
        ...
        <select name="month" id="mesSelecionado" class="border rounded px-2 py-1" onchange="this.form.submit()">
            <?php $__currentLoopData = $mesesDisponiveis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($mes->month); ?>" <?php if($mes->equalTo($month)): echo 'selected'; endif; ?>><?php echo e($mes->translatedFormat('F')); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
...
<?php $clinic = $clinics->firstWhere('id', $clinicId); ?>
<?php $__currentLoopData = $weeks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <h2 class="mt-6 font-semibold">Semana de <?php echo e($w->format('d/m/Y')); ?></h2>
        ...
        <table class="table-fixed w-full text-sm border">
            <thead>
                <tr>
                    ...
                    <?php $__currentLoopData = $dias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <th class="px-2 py-1 text-center font-semibold capitalize border border-gray-200 <?php echo e($outMonth ? 'bg-gray-100 text-gray-500' : 'bg-white'); ?>" style="width:14.28%">
                            <?php echo e(ucfirst($d->toName())); ?><br>
                            <span class="text-xs <?php echo e($outMonth ? 'text-gray-400' : 'text-gray-500'); ?>"><?php echo e($date->format('d/m')); ?></span>
                        </th>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tr>
            </thead>
            <tbody>
                <?php $__currentLoopData = $cadeiras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cadeira): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="w-32 px-2 py-1 font-semibold bg-gray-50 border border-gray-200"><?php echo e($cadeira->nome); ?></td>
                        <?php $__currentLoopData = $dias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                            <td class="px-2 py-2 border border-gray-200 align-top space-y-2 <?php echo e($outMonth ? 'bg-gray-100 text-gray-500' : ''); ?>" style="width:14.28%">
                                <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php echo $__env->make('escalas.partials.card', ['it' => $it, 'clinic' => $clinic, 'diaSemana' => $d->value, 'out' => $outMonth], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <span class="text-sm <?php echo e($outMonth ? 'text-gray-500' : 'text-gray-400'); ?>">Livre</span>
                                <?php endif; ?>
                            </td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tr>
...
<div id="copy-modal" class="fixed inset-0 bg-black/50 hidden flex items-center justify-center z-50">
    <div class="bg-white rounded p-4 w-80">
        <form method="POST" action="<?php echo e(route('escalas.copy')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <select name="source_month" class="w-full border rounded px-2 py-1">
                    <?php $__currentLoopData = $mesesDisponiveis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!$mes->equalTo($month)): ?>
                            <option value="<?php echo e($mes->format('Y-m')); ?>"><?php echo e($mes->translatedFormat('F Y')); ?></option>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
...
<div id="escala-modal" class="fixed inset-0 bg-black/50 hidden flex items-center justify-center z-50">
    <div class="bg-white rounded p-4 w-96">
        <form method="POST" action="<?php echo e(route('escalas.store')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="clinic_id" value="<?php echo e($clinicId); ?>">
            <input type="hidden" name="year" id="form-year" value="<?php echo e($month->year); ?>">
            <input type="hidden" name="month" id="form-month" value="<?php echo e($month->month); ?>">
            <input type="hidden" id="calendar-month-input" value="<?php echo e($month->format('Y-m')); ?>">
            <div>
                <label class="block text-sm mb-1">Profissional</label>
                <select name="profissional_id" class="w-full border rounded px-2 py-1">
                    <?php $__currentLoopData = $dentistas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($d->id); ?>"><?php echo e($d->pessoa->primeiro_nome); ?> <?php echo e($d->pessoa->ultimo_nome); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="cadeira_id" class="w-full border rounded px-2 py-1">
                    <?php $__currentLoopData = $cadeiras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    document.getElementById('open-modal').addEventListener('click', () => {
        escalaForm.reset();
        escalaForm.action = '<?php echo e(route('escalas.store')); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dentix\resources\views/escalas/index.blade.php ENDPATH**/ ?>